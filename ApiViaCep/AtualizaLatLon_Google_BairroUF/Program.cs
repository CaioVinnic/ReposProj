...
namespace AtualizaLatLon_Google_BairroUF
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            else
            {
                ...
                {
                    object[] parameters = new object[] { lstCepGeo[i].BAIRRO, lstCepGeo[i].CIDADE, lstCepGeo[i].UF };
        ...
        static List<cep_geo_csv> GetData(string uf)
        {
            ...
            "   [BAIRRO] = n90.tx_end_bairro, " +
            "   cep.LATITUDE, " +
            "   cep.LONGITUDE, " +
            "   cep.VALIDACAO " +
            "from " +
            "   cep_geo_csv_230518 cep " +
            "left join " +
            "   n90(nolock) " +
            "   on n90.tx_end_cep = cep.cep " +
            "where " +
            "   cep.uf = @uf " +
